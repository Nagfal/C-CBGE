...
class agent(object):
    ...
    def decision(self, purt):
        ...
        # self.purt = numpy.random.gumbel(gamma,1.0,size=[ self.num_arm])
        ...
        # confidence_list = self.BGE_get_confidence_list(neighbor_sample_nums) 
        ...
        for i in range(0,len(est_list)):
            ...
            #BGE            
            # est_list[i] = self.accu_reward_arm[i] / self.sample_number[i] + var_est[i]
